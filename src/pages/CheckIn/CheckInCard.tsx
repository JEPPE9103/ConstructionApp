  ...
  return (
    <div className="w-full bg-gradient-to-br from-[#e8fef1] to-[#f8fbff] rounded-2xl shadow-xl p-4 md:p-8 animate-fade-in">
      <div className="flex items-center mb-8 gap-3">
        ...
        <h1 className="text-2xl font-bold text-gray-800">{t('check_in_out')}</h1>
      </div>
      <form className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
              <ClipboardList size={18} className="text-green-400" /> {t('check_type')}
            </label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
              <Folder size={18} className="text-green-400" /> {t('project')}
            </label>
            <select
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-200 focus:border-green-400 transition-colors"
              required
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
            <MapPin size={18} className="text-green-400" /> {t('location')}
          </label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-2">
            <FileText size={18} className="text-green-400" /> {t('notes')}
          </label>
          <textarea
            rows={3}
