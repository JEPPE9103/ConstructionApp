...
const DashboardHomeCards = () => (
  <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-8">
    ...
    <Link
      ...
      className="flex items-center bg-[#f0f4ff] rounded-xl p-4 md:p-6 shadow transition hover:scale-105 duration-200 cursor-pointer gap-4"
    >
    ...
    <Link
      ...
      className="flex items-center bg-[#e8fef1] rounded-xl p-4 md:p-6 shadow transition hover:scale-105 duration-200 cursor-pointer gap-4"
    >
  ...
  className="flex items-center bg-[#e0f7ff] rounded-xl p-4 md:p-6 shadow transition hover:scale-105 duration-200 cursor-pointer gap-4"
>
  ...
  <div>
    ...
    <Link
      to="/dashboard/salary"
      className="flex items-center bg-[#fff9e5] rounded-xl p-4 md:p-6 shadow transition hover:scale-105 duration-200 cursor-pointer gap-4"
    >
    ...
    <Link
      to="/dashboard/upload"
      className="flex items-center bg-[#f5f0ff] rounded-xl p-4 md:p-6 shadow transition hover:scale-105 duration-200 cursor-pointer gap-4"
    >
  ...
  className="flex items-center bg-[#fef2f2] rounded-xl p-4 md:p-6 shadow transition hover:scale-105 duration-200 cursor-pointer gap-4"
>
